...
setup(
    ...
    description="blazing fast template matching when possible images are all known. Good for GUI scripting.",
    ...
    url="https://github.com/Madoshakalaka/whichimg",  # Optional
    ...
    entry_points={"console_scripts": ["whichimg=whichimg.main:cmd"]},  # Optional
